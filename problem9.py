#find common elements  in these sorted arrays by dictionary intersection.
...
#        ar3 = [5, 5, 10, 20]
#Output: [5, 5]
3#Recommended: Please try your approach on {IDE} first, before moving on to the solution.
